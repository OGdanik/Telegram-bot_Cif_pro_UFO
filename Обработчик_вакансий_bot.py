...
def get_text_messages(message):
    if message.text == "/start":
        bot.send_message(message.from_user.id, "Здравствуйте, с помощью этого бота вы можете найти желаемые вакансии, отправьте сообщение с желаемыми вакансиями.")
    elif message.text == "/help":
        bot.send_message(message.from_user.id, "Напишите в сообщении желаемые вакансии.")
    else:
...
*Должностные обязанности:* {filter_data['responsibilities(Должностные обязанности)'][idx]}
